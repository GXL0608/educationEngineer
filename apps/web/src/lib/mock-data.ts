...
export type LessonId = keyof typeof lessonText;
...
export const conceptBoards = {
  ...
  "concept-evidence-chain": {
    ...
    chain: [
      "先抓 claim",
      "把 supporting evidence 挂上去",
      "把假设和局限拆开"
    ]
  }
} as const;

export type ConceptId = keyof typeof conceptBoards;
...
export type PracticeId = keyof typeof practiceSets;
...
export type ExamId = keyof typeof examSets;
